...
class EmoteWheel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double wheelWidth = (screenWidth * 0.6).clamp(
      minWheelWidth,
      maxWheelWidth,
    );
    ...
    return SizedBox(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final double pathRadius = (wheelWidth * 0.19).clamp(
            50.0,
            110.0,
          ); // Path radius
          final center = Offset(
          ...
          return CustomPaint(
            ...
            child: Stack(
              children: List.generate(emotes.length, (index) {
                ...
                final double normalizedItemAngle = math.atan2(
                  math.sin(itemAngle),
                  math.cos(itemAngle),
                );
                ...
                final double normalizedAngle =
                    (angleDifference / (visibleAngle / 2)).clamp(0.0, 1.0);
                final double scaleFalloff = math.cos(
